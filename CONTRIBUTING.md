...
![ls -lah models](image-3.png)
*Generated model directory*

![runs_leaderboard.csv](image-4.png)
*Artifact generated after run of "02_compare_runs.ipynb"*

![dvc dag](<dvc dag output.png>)
*Output of "dvc dag"*

![dvc status --cloud](image-5.png)
*Output of "dvc status --cloud"*

### 2. Cloud Deployment

![kubectl get pods -o wide](<kubectl get pods-1.png>)
*Running pod in AWS EKS cluster*

![in-cluster smoke test logs](<kubectl -n $K8SNAMESPACE logs svc-smoke.png>)
*In-cluster smoke test logs*

![Docker health](terraform_get_health-1.png)
*Health check of running API with infrastructure provisioned using Terraform*

![alt text](terraform_predict_output.png)
*Predictions from running API*

![terraform_output.png](terraform_output.png)
*IP of publically accessible API*

### 3. CI/CD Gates \& Rollback

![Pytest output](<pytest -q cookiecutter generated repo-1.png>)
*Successfull tests using Pytest*

![postdeploygate.json](image-2.png)
*Post-Deploy artifact*

*Before rollout*
![Before rollout](<kubectl rollout history before.png>)

*After rollout*
![After rollout](<kubectl rollout history after.png>)
...
**Attach screenshot of:** Prometheus Targets UP, Grafana p95 panel; alert FIRING at http://127.0.0.1:9090/alerts; `reports_from_cluster/drift_report.html`, `cat reports/drift_summary.json` (PSI <0.2 clean vs >0.2 drift).
![Prometheus Targets UP](prometheus_targets.png)
*Prometheus Targets UP*

![Grafana p95 panel](prometheus_promql_query_graph-1.png)
*Grafana p95 panel*

![alert FIRING at http://127.0.0.1:9090/alerts](prometheus_alerts-1.png)
*alert FIRING at http://127.0.0.1:9090/alerts*

![reports_from_cluster/drift_report.html](drift-reports_html.png)
*In-cluster generated Evidently AI drift report*

![drift-summary.json](image-1.png)
*Drift summary*

### 5. Collaboration Tools

**Attach screenshot of:** Cookiecutter generation + pytest in tmp/; Sphinx `make -C docs html`; MLflow UI from notebooks.
![cookiecutter generated repo](<cookiecutter geenrated repo.png>)
*cookiecutter generated repo*

![Tests in generated repo](<pytest -q cookiecutter generated repo.png>)
*Tests in generated repo*

![docs-and-quality-workflow-run](docs-ans-quality-ci-workflow.png)
*docs-and-quality-workflow-run*

![Sphinx docs](sphinx-docs-index-html.png)
![Sphinx docs](sphinx-docs-index-html2.png)
*Sphinx docs*

![MLFlow UI runs list](<screenshot of MLflow UI runs list-1.png>)
*MLFlow UI runs list*
